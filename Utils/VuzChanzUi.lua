...
function VuzChanzUI:Create(Class, Properties)
...
function VuzChanzUI:Draggable(a)
...
function VuzChanzUI:Button(Parent): TextButton
    return VuzChanzUI:Create("TextButton", {
        Name = "Click",
        Parent = Parent,
...
function VuzChanzUI.Effect(c, p)
    ...
    local ClickButtonCircle = VuzChanzUI:Create("Frame", {
        Parent = p,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
...
function VuzChanzUI:NewRows(Parent, Title, Desciption)
    local Rows = VuzChanzUI:Create("Frame", {
        Name = "Rows",
        Parent = Parent,
    ...
    VuzChanzUI:Create("UIListLayout", {
        Parent = Rows,
    ...
    VuzChanzUI:Create("UIPadding", {
        Parent = Rows,
        PaddingBottom = UDim.new(0, 6),
        PaddingTop = UDim.new(0, 5)
    })

    local Vectorize_1 = VuzChanzUI:Create("Frame", {
        Name = "Vectorize",
        Parent = Rows,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Right_1 = VuzChanzUI:Create("Frame", {
        Name = "Right",
        Parent = Vectorize_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Left_1 = VuzChanzUI:Create("Frame", {
        Name = "Left",
        Parent = Vectorize_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Text_1 = VuzChanzUI:Create("Frame", {
        Name = "Text",
        Parent = Left_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
...
function VuzChanzUI:Window(Args)
    local Title = Args.Title or "ChizChanz HUB Project"
    local SubTitle = Args.SubTitle or "Made by VuzChanz"

    local DracoChanz = VuzChanzUI:Create("ScreenGui", {
        Name = "DracoChanz",
        Parent = VuzChanzUI:Parent(),
        ZIndexBehavior = Enum.ZIndexBehavior.Global,
        IgnoreGuiInset = true
    })

    local Background_1 = VuzChanzUI:Create("Frame", {
        Name = "Background",
        Parent = DracoChanz,
        AnchorPoint = Vector2.new(0.5, 0.5),
    ...
    function VuzChanzUI:IsDropdownOpen()
    ...
    -- Header
    local Header_1 = VuzChanzUI:Create("Frame", {
        Name = "Header",
        Parent = Background_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    -- Return button
    local Return_1 = VuzChanzUI:Create("ImageLabel", {
        Name = "Return",
        Parent = Header_1,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    -- HeadScale
    local HeadScale_1 = VuzChanzUI:Create("Frame", {
        Name = "HeadScale",
        Parent = Header_1,
    ...
    -- Info (title + subtitle)
    local Info_1 = VuzChanzUI:Create("Frame", {
        Name = "Info",
        Parent = HeadScale_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Title_1 = VuzChanzUI:Create("TextLabel", {
        Name = "Title",
        Parent = Info_1,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    -- Expires
    local Expires_1 = VuzChanzUI:Create("Frame", {
        Name = "Expires",
        Parent = HeadScale_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Asset_1 = VuzChanzUI:Create("ImageLabel", {
        Name = "Asset",
        Parent = Expires_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local Info_2 = VuzChanzUI:Create("Frame", {
        Name = "Info",
        Parent = Expires_1,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    local Title_2 = VuzChanzUI:Create("TextLabel", {
        Name = "Title",
        Parent = Info_2,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    local THETIME = VuzChanzUI:Create("TextLabel", {
        Name = "Time",
        Parent = Info_2,
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    -- Scale (body)
    local Scale_1 = VuzChanzUI:Create("Frame", {
        Name = "Scale",
        Parent = Background_1,
    ...
    local Home_1 = VuzChanzUI:Create("Frame", {
        Name = "Home",
        Parent = Scale_1,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        BackgroundTransparency = 1,
    ...
    local MainTabsScrolling = VuzChanzUI:Create("ScrollingFrame", {
        Name = "ScrollingFrame",
        Parent = Home_1,
        Active = true,
        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
    ...
    local UIListLayout_1 = VuzChanzUI:Create("UIListLayout", {
        Parent = MainTabsScrolling,
        Padding = UDim.new(0, 10),
        FillDirection = Enum.FillDirection.Horizontal,
        SortOrder = Enum.SortOrder.LayoutOrder,
    ...
    local PageService: UIPageLayout = VuzChanzUI:Create("UIPageLayout", {
        Parent = Scale_1
    })
    ...
    function Window:NewPage(Args)
        ...
        local NewTabs = VuzChanzUI:Create("Frame", {
            Name = "NewTabs",
            Parent = MainTabsScrolling,
        ...
        local Click = VuzChanzUI:Button(NewTabs)
        ...
        local Banner_1 = VuzChanzUI:Create("ImageLabel", {
            Name = "Banner",
            Parent = NewTabs,
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = 1,
        ...
        local Icon_1 = VuzChanzUI:Create("ImageLabel", {
            Name = "Icon",
            Parent = Info_1,
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = 1,
        ...
        local NewPage = VuzChanzUI:Create("Frame", {
            Name = "NewPage",
            Parent = Scale_1,
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            BackgroundTransparency = 1,
        ...
        local PageScrolling_1 = VuzChanzUI:Create("ScrollingFrame", {
            Name = "PageScrolling",
            Parent = NewPage,
            Active = true,
            BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ...
        local UIListLayout_2 = VuzChanzUI:Create("UIListLayout", {
            Parent = PageScrolling_1,
        ...
        local function OnChangPage()
            local RightTweening = VuzChanzUI:Tween({
                v = HeadScale_1,
                t = 0.2,
                s = "Exponential",
                d = "Out",
        ...
        function Page:Section(Text)
            local Title = VuzChanzUI:Create("TextLabel", {
                Name = "Title",
                Parent = PageScrolling_1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
        ...
        function Page:Paragraph(Args)
            ...
            local Rows = VuzChanzUI:NewRows(PageScrolling_1, Title, Desc)

            local Left = Rows.Vectorize.Left.Text
            local Right = Rows.Vectorize.Right

            local IconLabel = VuzChanzUI:Create("ImageLabel", {
                Parent = Right,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
        ...
        function Page:Button(Args)
            ...
            local Button = VuzChanzUI:Create("Frame", {
                Name = "Button",
                Parent = Right,
            ...
            local TextLabel: TextLabel = VuzChanzUI:Create("TextLabel", {
                Name = "Title",
                Parent = Button,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            ...
            local Click = VuzChanzUI:Button(Button)

            local function Onlick()
                if VuzChanzUI:IsDropdownOpen() then return end
                task.spawn(VuzChanzUI.Effect, Click, Button)
        ...
        function Page:Toggle(Args)
            ...
            local Background = VuzChanzUI:Create("Frame", {
                Name = "Background",
                Parent = Right,
                BackgroundColor3 = Color3.fromRGB(10, 10, 10),
                BorderColor3 = Color3.fromRGB(0, 0, 0),
            ...
            local UIStroke = VuzChanzUI:Create("UIStroke", {
                Parent = Background,
                Color = Color3.fromRGB(25, 25, 25),
                Thickness = 0.5
            })
            ...
            local Highligh_1 = VuzChanzUI:Create("Frame", {
                Name = "Highligh",
                Parent = Background,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 0, 127),
            ...
            local ImageLabel_1 = VuzChanzUI:Create("ImageLabel", {
                Parent = Highligh_1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
            ...
            local Click = VuzChanzUI:Button(Background)
            ...
            local function OnChanged(value)
                if value then
                    ...
                    VuzChanzUI:Tween({ v = Highligh_1, t = 0.5, s = "Exponential", d = "Out", g = { BackgroundTransparency = 0 } }):Play()
                    VuzChanzUI:Tween({ v = ImageLabel_1, t = 0.5, s = "Exponential", d = "Out", g = { ImageTransparency = 0 } }):Play()
                    VuzChanzUI:Tween({ v = ImageLabel_1, t = 0.3, s = "Exponential", d = "Out", g = { Size = UDim2.new(0.5, 0, 0.5, 0) } }):Play()
                    UIStroke.Thickness = 0
                else
                    Callback(Data.Value)

                    TitleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
                    VuzChanzUI:Tween({ v = Highligh_1, t = 0.5, s = "Exponential", d = "Out", g = { BackgroundTransparency = 1 } }):Play()
                    VuzChanzUI:Tween({ v = ImageLabel_1, t = 0.5, s = "Exponential", d = "Out", g = { ImageTransparency = 1 } }):Play()
        ...
        function Page:Slider(Args)
            ...
            local Slider_1 = VuzChanzUI:Create("Frame", {
                Name = "Slider",
                Parent = PageScrolling_1,
                BackgroundColor3 = Color3.fromRGB(15, 15, 15),
            ...
            local Scaling_1 = VuzChanzUI:Create("Frame", {
                Name = "Scaling",
                Parent = Slider_1,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
            ...
            local Slide_1 = VuzChanzUI:Create("Frame", {
                Name = "Slide",
                Parent = Scaling_1,
                AnchorPoint = Vector2.new(0, 1),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            ...
            local ColorBar_1 = VuzChanzUI:Create("Frame", {
                Name = "ColorBar",
                Parent = Slide_1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(10, 10, 10),
            ...
            local ColorBar_2 = VuzChanzUI:Create("Frame", {
                Name = "ColorBar",
                Parent = ColorBar_1,
                BackgroundColor3 = Color3.fromRGB(255, 0, 127),
                BorderSizePixel = 0,
            ...
            local Boxvalue_1 = VuzChanzUI:Create("TextBox", {
                Name = "Boxvalue",
                Parent = Scaling_1,
                AnchorPoint = Vector2.new(1, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            ...
            local function SetDragging(state)
                ...
                if state then
                    VuzChanzUI:Tween({ v = Boxvalue_1, t = 0.3, s = "Back", d = "Out", g = { TextSize = 15 } }):Play()
                    VuzChanzUI:Tween({ v = Boxvalue_1, t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = pink  } }):Play()
                    VuzChanzUI:Tween({ v = Title_1,    t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = pink  } }):Play()
                else
                    VuzChanzUI:Tween({ v = Boxvalue_1, t = 0.3, s = "Back", d = "Out", g = { TextSize = 11 } }):Play()
                    VuzChanzUI:Tween({ v = Boxvalue_1, t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = white } }):Play()
                    VuzChanzUI:Tween({ v = Title_1,    t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = white } }):Play()
                end
            end
            ...
            local ClickButton = VuzChanzUI:Button(Slider_1)
        ...
        function Page:Input(Args)
            ...
            local Input_1 = VuzChanzUI:Create("Frame", {
                Name = "Input",
                Parent = PageScrolling_1,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
            ...
            local Front_1 = VuzChanzUI:Create("Frame", {
                Name = "Front",
                Parent = Input_1,
                BackgroundColor3 = Color3.fromRGB(15, 15, 15),
                BorderSizePixel = 0,
            ...
            local TextBox_1 = VuzChanzUI:Create("TextBox", {
                Parent = Front_1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
            ...
            local Enter_1 = VuzChanzUI:Create("Frame", {
                Name = "Enter",
                Parent = Input_1,
                BackgroundColor3 = Color3.fromRGB(255, 0, 127),
                BorderSizePixel = 0,
            ...
            local Asset = VuzChanzUI:Create("ImageLabel", {
                Name = "Asset",
                Parent = Enter_1,
                AnchorPoint = Vector2.new(0.5, 0.5),
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
            ...
            local Copy = VuzChanzUI:Button(Enter_1)
        ...
        function Page:Dropdown(Args)
            ...
            local Rows = VuzChanzUI:NewRows(PageScrolling_1, Title, "N/A")
            local Right = Rows.Vectorize.Right

            local Icon = VuzChanzUI:Create("ImageLabel", {
                Parent = Right,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
                BorderColor3 = Color3.fromRGB(0, 0, 0),
            ...
            local Open = VuzChanzUI:Button(Rows.Vectorize)
            local Left = Rows.Vectorize.Left.Text
            ...
            do
                local Dropdown_1 = VuzChanzUI:Create("Frame", {
                    Name = "Dropdown",
                    Parent = Background_1,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                ...
                local Desc_1 = VuzChanzUI:Create("TextLabel", {
                    Name = "Desc",
                    Parent = Text_1,
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                ...
                local List_1 = VuzChanzUI:Create("ScrollingFrame", {
                    Name = "List",
                    Parent = Dropdown_1,
                    BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                    BackgroundTransparency = 1,
                ...
                local ScrollLayout = VuzChanzUI:Create("UIListLayout", {
                    Parent = List_1,
                ...
                Open.MouseButton1Click:Connect(function()
                    ...
                    if isOpen then
                        ...
                        VuzChanzUI:Tween({ v = Dropdown_1, t = 0.3, s = "Back", d = "Out", g = { Position = UDim2.new(0.5, 0, 0.5, 0) } }):Play()
                    else
                        Dropdown_1.Visible = false
                        Dropdown_1.Position = UDim2.new(0.5, 0, 0.3, 0)
                    end
                ...
                function Setting:AddList(Name)
                    local NewList_1 = VuzChanzUI:Create("Frame", {
                        Name = "NewList",
                        Parent = List_1,
                        BackgroundColor3 = Color3.fromRGB(0, 0, 0),
                        BackgroundTransparency = 1,
                    ...
                    local Click = VuzChanzUI:Button(Title_2)
        ...
        function Page:Banner(Assets)
            local NewBanner_1 = VuzChanzUI:Create("ImageLabel", {
                Name = "NewBanner",
                Parent = PageScrolling_1,
                BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                BackgroundTransparency = 1,
    ...
    do
        ...
        VuzChanzUI:Draggable(Background_1) 
        ...
        VuzChanzUI.PageService = PageService

        Scale_1.ClipsDescendants = true

        local Return_Button = VuzChanzUI:Button(Return_1)
        ...
        do
            local ToggleScreen = VuzChanzUI:Create("ScreenGui", {
                Name = "DracoChanz",
                Parent = VuzChanzUI:Parent(),
                ZIndexBehavior = Enum.ZIndexBehavior.Global,
                IgnoreGuiInset = true
        ...
        do
            ...
            local Scaler = VuzChanzUI:Create("UIScale", {
                Parent = DracoChanz,
                Scale = if Mobile then 1 else WindowSize
            })
            
            function VuzChanzUI:SizeSlider(Page, Plugins)
                return Plugins:Slider(Page, "Interface Scaler", { 1, 2, 2 }, "Interface Scaler", function(v)
                    Scaler.Scale = v
                end)
            end
            
            function VuzChanzUI:SetTimeValue(Value)
                THETIME.Text = Value
            end
        end
